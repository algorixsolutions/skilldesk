...
import 'details04_event_model.dart';
export 'details04_event_model.dart';

class Details04EventWidget extends StatefulWidget {
  const Details04EventWidget({super.key});

  @override
  State<Details04EventWidget> createState() => _Details04EventWidgetState();
}

class _Details04EventWidgetState extends State<Details04EventWidget> {
  late Details04EventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Details04EventModel());
  }
