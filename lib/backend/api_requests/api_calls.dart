...
class HomeInfosCall {
  ...
  dynamic upcoming(dynamic response) => getJsonField(
        response,
        r'''$.upcoming''',
        true,
      );
...
class GetQuizzesCall {
  ...
  dynamic quizData(dynamic response) => getJsonField(
        response,
        r'''$.data''',
        true,
      );
  dynamic labelList(dynamic response) => getJsonField(
        response,
        r'''$.data[:].label_theme''',
        true,
      );
...
class GetThemesCall {
  ...
  dynamic idList(dynamic response) => getJsonField(
        response,
        r'''$[:].id''',
        true,
      );
...
class GetTrainingsCall {
  ...
  dynamic trainingData(dynamic response) => getJsonField(
        response,
        r'''$.data''',
        true,
      );
...
class GetTrainingListCall {
  ...
  static dynamic trainingsData(dynamic response) => getJsonField(
        response,
        r'''$.data''',
        true,
      );
