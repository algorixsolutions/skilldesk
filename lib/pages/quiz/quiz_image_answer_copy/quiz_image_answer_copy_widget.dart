...
import 'quiz_image_answer_copy_model.dart';
export 'quiz_image_answer_copy_model.dart';

class QuizImageAnswerCopyWidget extends StatefulWidget {
  const QuizImageAnswerCopyWidget({
    super.key,
  ...
  @override
  State<QuizImageAnswerCopyWidget> createState() =>
      _QuizImageAnswerCopyWidgetState();
}

class _QuizImageAnswerCopyWidgetState extends State<QuizImageAnswerCopyWidget> {
  late QuizImageAnswerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizImageAnswerCopyModel());
