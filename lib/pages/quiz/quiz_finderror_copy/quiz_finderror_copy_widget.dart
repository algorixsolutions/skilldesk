...
import 'quiz_finderror_copy_model.dart';
export 'quiz_finderror_copy_model.dart';

class QuizFinderrorCopyWidget extends StatefulWidget {
  const QuizFinderrorCopyWidget({
    super.key,
  ...
  @override
  State<QuizFinderrorCopyWidget> createState() =>
      _QuizFinderrorCopyWidgetState();
}

class _QuizFinderrorCopyWidgetState extends State<QuizFinderrorCopyWidget> {
  late QuizFinderrorCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizFinderrorCopyModel());
