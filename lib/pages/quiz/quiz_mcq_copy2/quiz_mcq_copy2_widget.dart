...
import 'quiz_mcq_copy2_model.dart';
export 'quiz_mcq_copy2_model.dart';

class QuizMcqCopy2Widget extends StatefulWidget {
  const QuizMcqCopy2Widget({
    super.key,
  ...
  @override
  State<QuizMcqCopy2Widget> createState() => _QuizMcqCopy2WidgetState();
}

class _QuizMcqCopy2WidgetState extends State<QuizMcqCopy2Widget> {
  late QuizMcqCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizMcqCopy2Model());
                        ...
                        Container(
                          ...
                          child: Align(
                            ...
                            child: LinearPercentIndicator(
                              percent: functions.getIndex(widget.index!) /
