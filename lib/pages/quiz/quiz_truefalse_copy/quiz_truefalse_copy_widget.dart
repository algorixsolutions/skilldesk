...
import 'quiz_truefalse_copy_model.dart';
export 'quiz_truefalse_copy_model.dart';

class QuizTruefalseCopyWidget extends StatefulWidget {
  const QuizTruefalseCopyWidget({
    super.key,
  ...
  @override
  State<QuizTruefalseCopyWidget> createState() =>
      _QuizTruefalseCopyWidgetState();
}

class _QuizTruefalseCopyWidgetState extends State<QuizTruefalseCopyWidget> {
  late QuizTruefalseCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizTruefalseCopyModel());
                          ...
                          return InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (functions.isValuePresent(
                                ...
                                setState(() {
                                  FFAppState().addToSelectedAns(answerIndex);
                                });
                                return;
                              }
                            },
