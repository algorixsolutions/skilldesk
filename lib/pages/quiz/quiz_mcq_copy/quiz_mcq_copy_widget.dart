...
import 'quiz_mcq_copy_model.dart';
export 'quiz_mcq_copy_model.dart';

class QuizMcqCopyWidget extends StatefulWidget {
  const QuizMcqCopyWidget({
    super.key,
  ...
  @override
  State<QuizMcqCopyWidget> createState() => _QuizMcqCopyWidgetState();
}

class _QuizMcqCopyWidgetState extends State<QuizMcqCopyWidget> {
  late QuizMcqCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizMcqCopyModel());
