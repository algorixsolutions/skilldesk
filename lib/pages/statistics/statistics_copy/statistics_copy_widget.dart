...
import 'statistics_copy_model.dart';
export 'statistics_copy_model.dart';

class StatisticsCopyWidget extends StatefulWidget {
  const StatisticsCopyWidget({
    super.key,
    String? period,
    this.theme,
  }) : period = period ?? 'day';
  ...
  @override
  State<StatisticsCopyWidget> createState() => _StatisticsCopyWidgetState();
}

class _StatisticsCopyWidgetState extends State<StatisticsCopyWidget> {
  late StatisticsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatisticsCopyModel());
  }
