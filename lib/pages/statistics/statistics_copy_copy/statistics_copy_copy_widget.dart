...
import 'statistics_copy_copy_model.dart';
export 'statistics_copy_copy_model.dart';

class StatisticsCopyCopyWidget extends StatefulWidget {
  const StatisticsCopyCopyWidget({
    super.key,
    String? period,
    this.theme,
  }) : period = period ?? 'day';
  ...
  @override
  State<StatisticsCopyCopyWidget> createState() =>
      _StatisticsCopyCopyWidgetState();
}

class _StatisticsCopyCopyWidgetState extends State<StatisticsCopyCopyWidget> {
  late StatisticsCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatisticsCopyCopyModel());
  }
