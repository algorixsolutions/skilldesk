...
import 'training_chapter_content_copy_model.dart';
export 'training_chapter_content_copy_model.dart';

class TrainingChapterContentCopyWidget extends StatefulWidget {
  const TrainingChapterContentCopyWidget({
    super.key,
  ...
  @override
  State<TrainingChapterContentCopyWidget> createState() =>
      _TrainingChapterContentCopyWidgetState();
}

class _TrainingChapterContentCopyWidgetState
    extends State<TrainingChapterContentCopyWidget> {
  late TrainingChapterContentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingChapterContentCopyModel());
