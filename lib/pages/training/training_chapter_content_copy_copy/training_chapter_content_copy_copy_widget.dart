...
import 'training_chapter_content_copy_copy_model.dart';
export 'training_chapter_content_copy_copy_model.dart';

class TrainingChapterContentCopyCopyWidget extends StatefulWidget {
  const TrainingChapterContentCopyCopyWidget({
    super.key,
  ...
  @override
  State<TrainingChapterContentCopyCopyWidget> createState() =>
      _TrainingChapterContentCopyCopyWidgetState();
}

class _TrainingChapterContentCopyCopyWidgetState
    extends State<TrainingChapterContentCopyCopyWidget> {
  late TrainingChapterContentCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingChapterContentCopyCopyModel());
